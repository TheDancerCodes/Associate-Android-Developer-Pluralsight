...
public class DatabaseDataWorker {
    ...
    // Constructor that accepts a reference to a SQLiteDatabase
    public DatabaseDataWorker(SQLiteDatabase db) {
        mDb = db;
    }

    // Handles details of adding 4 rows to our course_info table
    ...
    // Handles details of adding rows to our note_info table to have some sample notes
